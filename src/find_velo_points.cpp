                ...
                velo2rs::Record::Response &res)
{
    if (req.position == "o")
    {
        ...
        ros::param::set("/velo/point_o/x",coord_o.x);
        ros::param::set("/velo/point_o/y",coord_o.y);
        ros::param::set("/velo/point_o/z",coord_o.z);
    }
    else if (req.position == "x")
    {
        ...
        ros::param::set("/velo/point_x/x",coord_x.x);
        ros::param::set("/velo/point_x/y",coord_x.y);
        ros::param::set("/velo/point_x/z",coord_x.z);
    }
    else if (req.position == "z")
    {
        ...
        ros::param::set("/velo/point_z/x",coord_z.x);
        ros::param::set("/velo/point_z/y",coord_z.y);
        ros::param::set("/velo/point_z/z",coord_z.z);      
    }
    else
    {
        return false;
